...
import copy
import numpy as np
from .utils import resample_posterior_distribution, logger

from .array import Array, _2DArray
from .dict import Dict
from .parameters import Parameters

from .configuration import colorcycle
# import importlib
...
class SamplesDict(Dict):
    ...
    def __init__(self, *args, logger_warn="warn", autoscale=True, jargon=None):
        if jargon is not None:
            latex_labels.update(jargon['labels'])
    ...
    def __str__(self):
        ...
        def format_string(string, row: list):
    ...
    # Idea: Implement what pesummary has for other areas
    ''' 
    ...
    def _corner(self, module="core", parameters=None, **kwargs):
        ...
        **kwargs: dict
            ...
            function
        """
        from .plot import _make_corner_plot
        _parameters = None
    ...
    def _2d_kde(self, parameters: list, module="core", **kwargs):
    ...
    def _triangle(self, parameters: list, module="core", **kwargs):
    ...
    def _reverse_triangle(self, parameters: list, module="core", **kwargs):
...
class _MultiDimensionalSamplesDict(Dict):
    ...
    def __init__(
            self, *args, label_prefix="dataset", transpose=False, labels: list = None
    ):
